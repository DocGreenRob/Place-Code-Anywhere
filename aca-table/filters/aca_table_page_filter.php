...
class aca_table_page_filter {
	...
	public function controls($total_rows, $rows_per_page) {
		...
		if ($prev_page) { // left arrow button
			...
			$res .= '<a class="prev page-numbers" href="?'. aca_table_func::change_qstring(self::VAR_NAME, $prev_page) .'">&laquo;</a> ';
		...
		if ($next_page) { // right arrow button
			...
			$res .= '<a class="next page-numbers" href="?'. aca_table_func::change_qstring(self::VAR_NAME, $next_page) .'">&raquo;</a> ';
	...
	protected function page_button($page, $cur_page, $var_name) {
		...
		if ($page == $cur_page) {
			...
			$res = '<a class="page-numbers" href="?'. aca_table_func::change_qstring($var_name, $page) .'">'. $page .'</a> ';
