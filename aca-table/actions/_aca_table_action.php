 ...
 * @author Max Bond
 * 
 * aca Table action abstract class
 *
 */
abstract class _aca_table_action {
	...
	public function __construct($plugin_id, $action_page = false) {
		...
		$this->wp_nonce = wp_create_nonce('aca_table_get'); // create nonce for get actions
	 ...
	 * 
	 * @param object $object instance of _aca_table_obj class
