 ...
 * @author Max Bond
 * 
 * This class describes properties of _aca_table_obj class properties
 *
 */
class _aca_table_obj_propertie {
	...
	public $input; // input object // instance of _aca_input class
	
	public $conv; // data conver object // instance of _aca_data_conv class
